        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Chat Group ↭  🔥', url='https://t.me/Movies_Anime_find') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ Chat Group ↭  🔥', url='https://t.me/Movies_Anime_find') ]
                                                                                    ] )
                )
