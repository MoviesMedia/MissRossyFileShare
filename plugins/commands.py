...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/Hindi_movie_v2"),
            InlineKeyboardButton('⚡ Anime Series ⚡', url=f"https://t.me/Anime_WorldSeries"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/its_backup_Home')],
                                           [InlineKeyboardButton('Anime', url='https://t.me/Anime_WorldSeries'),
                                           InlineKeyboardButton('Movies', url='https://t.me/Hindi_movie_v2')] ]),
        protect_content=True if pre == 'filep' else False,
        )
